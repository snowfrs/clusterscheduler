...
#define MSG_ANSWER_XISNOTAVALIDOPTIONY_SU          _MESSAGE(23133, _(SFQ " is not a valid option " sge_u32))
...
#define MSG_STREE_NOVALIDNODEREF_U                 _MESSAGE(23222, _("found reference to node " sge_u32 " but no specification"))
...
#define MSG_SGETEXT_UNKNOWN_ATTR_TYPE_U            _MESSAGE(23261, _("unknown complex attribute type " sge_u32))
...
#define MSG_SEC_NOCRED_USSI               _MESSAGE(60406, _("could not get credentials for job " sge_u32 " for execution host " SFN " - command " SFQ " failed with return code %d"))
#define MSG_SEC_STARTDELCREDCMD_SU        _MESSAGE(60407, _("can't start command " SFQ " for job " sge_u32 " to delete credentials"))
#define MSG_SEC_NOAUTH_U                  _MESSAGE(60408, _("job " sge_u32 " rejected because authentication failed (no credentials supplied)"))
#define MSG_SEC_NOSTORECRED_USI           _MESSAGE(60409, _("could not store credentials for job " sge_u32" - command " SFQ " failed with return code %d"))
#define MSG_SEC_NOSTORECREDNOBIN_US       _MESSAGE(60410, _("could not store client credentials for job " sge_u32" - " SFN " binary does not exist"))
#define MSG_SEC_DELCREDSTDERR_S           _MESSAGE(60411, _("delete_cred stderr: " SFN))
#define MSG_SEC_DELCREDRETCODE_USI        _MESSAGE(60412, _("could not delete credentials for job " sge_u32 " - command " SFQ " failed with return code %d"))
