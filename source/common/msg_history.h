...
#define MSG_HISTORY_IGNORINGINVALIDENTRYINLINEX_U     _MESSAGE(25076, _("ignoring invalid entry in line " sge_u32))
...
#define MSG_HISTORY_JOBARRAYTASKSWXYZNOTFOUND_UUUU    _MESSAGE(25084, _("Job-array tasks " sge_u32 "." sge_u32 "-" sge_u32 ":" sge_u32 " not found" ))
#define MSG_HISTORY_JOBIDXNOTFOUND_U                  _MESSAGE(25085, _("job id " sge_u32 " not found"))
#define MSG_HISTORY_JOBARRAYTASKSWXYZNOTFOUND_SUUU    _MESSAGE(25086, _("Job-array tasks " SFQ "." sge_u32 "-" sge_u32 ":" sge_u32 " not found"))
