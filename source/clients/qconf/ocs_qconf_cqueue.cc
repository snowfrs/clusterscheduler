...
cqueue_add_del_mod_via_gdi(lListElem *this_elem, lList **answer_list, ocs::gdi::Command gdi_command, ocs::gdi::SubCommand sub_cmd)
{
   ...
   if (this_elem != nullptr) {
      ...
      if (ret) {
         ...
         gdi_answer_list = ocs::gdi::Client::sge_gdi(ocs::gdi::Target::CQ_LIST, gdi_command, sub_cmd, &cqueue_list, nullptr, nullptr);
...
cqueue_get_via_gdi(lList **answer_list, const char *name)
{
   ...
   if (name != nullptr) {
      ...
      gdi_answer_list = ocs::gdi::Client::sge_gdi(ocs::gdi::Target::CQ_LIST, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, &cqueue_list, where, what);
      lFreeWhat(&what);
      lFreeWhere(&where);
                                      ...
                                      lList **cq_list)
{
   ...
   if (hgrp_list != nullptr && cq_list != nullptr) {
      ...
      if (ret && fetch_all_hgroup) {
         ...
         hgrp_id = gdi_multi.request(answer_list, ocs::gdi::Mode::RECORD, ocs::gdi::Target::HGRP_LIST, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, nullptr, nullptr, what, true);
         lFreeWhat(&what);
      }
      if (ret) {
         lEnumeration *what;
         ...
         cq_id = gdi_multi.request(answer_list, ocs::gdi::Mode::SEND, ocs::gdi::Target::CQ_LIST, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, nullptr, cqueue_where, what, true);
         gdi_multi.wait();
         lFreeWhat(&what);
      }
      if (ret && fetch_all_hgroup) {
         ...
         gdi_multi.get_response(&local_answer_list, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, ocs::gdi::Target::HGRP_LIST, hgrp_id, hgrp_list);
      ...
      if (ret) {
         ...
         gdi_multi.get_response(&local_answer_list, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, ocs::gdi::Target::CQ_LIST, cq_id, cq_list);
         if (local_answer_list != nullptr) {
            lListElem *answer = lFirstRW(local_answer_list);
                              ...
                              lList **hgrp_list, lList **cq_list)
{
   ...
   if (hgrp_list != nullptr && cq_list != nullptr) {
      ...
      hgrp_id = gdi_multi.request(answer_list, ocs::gdi::Mode::RECORD, ocs::gdi::Target::HGRP_LIST, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, nullptr, nullptr, hgrp_what, true);
      lFreeWhat(&hgrp_what);

      /* CQ */
      cqueue_what = lWhat("%T(ALL)", CQ_Type);
      cq_id = gdi_multi.request(answer_list, ocs::gdi::Mode::SEND, ocs::gdi::Target::CQ_LIST, ocs::gdi::Command::GET, ocs::gdi::SubCommand::NONE, nullptr, nullptr, cqueue_what, true);
      gdi_multi.wait();
...
cqueue_modify(lList **answer_list, const char *name)
{
   ...
   if (name != nullptr) {
      ...
      if (ret) {
         ret &= cqueue_add_del_mod_via_gdi(cqueue, answer_list, ocs::gdi::Command::MOD, ocs::gdi::SubCommand::SET_ALL);
      }
      lFreeElem(&cqueue);
   }
...
cqueue_delete(lList **answer_list, const char *name)
{
   ...
   if (name != nullptr) {
      ...
      if (cqueue != nullptr) {
         ret &= cqueue_add_del_mod_via_gdi(cqueue, answer_list, ocs::gdi::Command::DEL, ocs::gdi::SubCommand::NONE);
      }
