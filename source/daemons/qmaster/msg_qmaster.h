...
#define MSG_JOB_IGNORE_DELETED_TASK_UU _MESSAGE(33013, _("ignoring obtained start order for deleted task: " sge_u32 "." sge_u32))
#define MSG_JOB_NOJOBID                _MESSAGE(33014, _("can't get job id"))
#define MSG_JOB_NOORDERTASK_US         _MESSAGE(33015, _("invalid task number 0 for job " sge_u32 " in " SFQ " order"))
#define MSG_JOB_FINDJOB_U              _MESSAGE(33016, _("unable to find job " sge_u32 " from the scheduler order package"))
#define MSG_JOB_FINDJOBTASK_UU         _MESSAGE(33017, _("unable to find task " sge_u32 " of job " sge_u32))

#define MSG_ORD_OLDVERSION_UUU         _MESSAGE(33018, _("scheduler sent a order for a modified job " sge_u32 "." sge_u32 " (Version: " sge_u32))
#define MSG_ORD_TWICE_UU               _MESSAGE(33019, _("scheduler tries to schedule job " sge_u32 "." sge_u32 " twice"))
...
#define MSG_ORD_QVERSION_SUU           _MESSAGE(33023, _("scheduler sent an order for a changed queue " SFQ " (version: old " sge_u32 " new " sge_u32))
#define MSG_ORD_USRPRJVERSION_SUU      _MESSAGE(33024, _("scheduler sent an order for a changed user/project " SFQ " (version: old " sge_u32 ") new " sge_u32))
#define MSG_JOB_JOBACCESSQ_US          _MESSAGE(33025, _("job " sge_u32 " has no access to queue " SFQ))
#define MSG_JOB_FREESLOTS_USUU         _MESSAGE(33026, _("not enough (" sge_u32 ") free slots in queue " SFQ " for job " sge_u32 "." sge_u32))
...
#define MSG_JOB_UNABLE2STARTJOB_US     _MESSAGE(33031, _("unable to start job " sge_u32 " before cleanup on host " SFN " has finished"))
#define MSG_JOB_HOSTNAMERESOLVE_US     _MESSAGE(33032, _("failed starting job " sge_u32 " - probably hostname resolving problem with " SFQ))
#define MSG_JOB_JOBDELIVER_UU          _MESSAGE(33033, _("failed delivering job " sge_u32 "." sge_u32))
#define MSG_JOB_UNABLE2FINDJOBORD_U    _MESSAGE(33034, _("unable to find job \"" sge_u32 "\" from the ticket order"))
#define MSG_JOB_CHANGETICKETS_UUU      _MESSAGE(33035, _("scheduler tries to change tickets of a non running job " sge_u32 " task " sge_u32 "(state " sge_u32 ")"))
#define MSG_JOB_CHANGEPTICKETS_UU      _MESSAGE(33036, _("scheduler tries to change pending tickets of a non pending job " sge_u32 " task " sge_u32))
#define MSG_JOB_REMOVENOTFINISHED_U    _MESSAGE(33037, _("scheduler tried to remove job " sge_u32 " which is not in state JFINISHED"))
#define MSG_JOB_REMOVENONINTERACT_U    _MESSAGE(33038, _("scheduler tried to remove non interactive job " sge_u32 " by use of a ORT_remove_immediate_job order"))
#define MSG_JOB_REMOVENONIMMEDIATE_U   _MESSAGE(33039, _("scheduler tried to remove non immediate job " sge_u32 " by use of a ORT_remove_immediate_job order"))
#define MSG_JOB_REMOVENOTIDLEIA_U      _MESSAGE(33040, _("scheduler tried to remove interactive job " sge_u32 " but it is not in JIDLE state"))
#define MSG_JOB_NOFREERESOURCEIA_UU    _MESSAGE(33041, _("no free resource for interactive job " sge_u32 "." sge_u32 " for user " SFQ))
#define MSG_JOB_ORDERDELINCOMPLETEJOB_UU  _MESSAGE(33042, _("scheduler tried to remove a incomplete job " sge_u32 "." sge_u32))
#define MSG_JOB_SUSPOTNOTRUN_UU        _MESSAGE(33043, _("got ORT_suspend_on_threshold order for non running task " sge_u32 "." sge_u32))
#define MSG_JOB_UNSUSPOTNOTRUN_UU      _MESSAGE(33044, _("got ORT_unsuspend_on_threshold order for non running task " sge_u32 "." sge_u32))
#define MSG_JOB_UNSUSPOT_UUS           _MESSAGE(33045, _("unsuspending job " sge_u32 "." sge_u32 " according to suspend threshold of queue " SFQ))
#define MSG_JOB_UNABLE2FINDMQ_SU       _MESSAGE(33046, _("unable to find master queue " SFN " of job " sge_u32))
#define MSG_JOB_SUSPTQ_UUS             _MESSAGE(33047, _("suspending job " sge_u32 "." sge_u32 " according to suspend threshold of queue " SFQ))
...
#define MSG_COM_ACKEVENTFORUNKNOWNJOB_SU _MESSAGE(33106, _("ack event from host " SFN " for unknown job " sge_u32))
#define MSG_COM_ACKEVENTFORUNKNOWNTASKOFJOB_SUU _MESSAGE(33107, _("ack event from host " SFN " for unknown task " sge_u32 " of job " sge_u32))
#define MSG_COM_UNKNOWN_TAG            _MESSAGE(33108, _("received unknown ack tag " sge_u32))
...
#define MSG_EVE_TE4AR_U                   _MESSAGE(33134, _("got timer event for unknown AR " sge_u32))
...
#define MSG_COM_CANT_DELIVER_UNHEARD_SSU  _MESSAGE(33137, _("got max. unheard timeout for target " SFQ " on host " SFQ ", can't deliver job \"" sge_u32 "\""))
#define MSG_OBJ_UNABLE2FINDCKPT_S     _MESSAGE(33138, _("can't find checkpointing object " SFQ))
#define MSG_OBJ_UNABLE2CREATECKPT_SU  _MESSAGE(33139, _("can't create checkpointing object " SFQ " for job " sge_u32))
#define MSG_COM_SENDJOBTOHOST_US      _MESSAGE(33142, _("can't send job \"" sge_u32"\" to host " SFQ))
#define MSG_COM_RESENDUNKNOWNJOB_UU   _MESSAGE(33143, _("cannot resend unknown job " sge_u32 "." sge_u32))
#define MSG_JOB_UNKNOWNGDIL4TJ_UU     _MESSAGE(33144, _("transfering job " sge_u32 "." sge_u32 " has an invalid gdi list --- deleting"))
#define MSG_JOB_NOQUEUE4TJ_SUU        _MESSAGE(33145, _("queue " SFQ " in transiting job " sge_u32 "." sge_u32 " doesn't exist. deleting task"))
#define MSG_JOB_NOHOST4TJ_SUU         _MESSAGE(33146, _("execution host " SFQ " for transfering job " sge_u32 "." sge_u32 " doesn't exist. deleting task"))
#define MSG_JOB_NOPE4TJ_SUU           _MESSAGE(33147, _("parallel environment " SFQ " for transfering job " sge_u32 "." sge_u32 " doesn't exist. deleting job"))
#define MSG_JOB_DELIVER2Q_UUS         _MESSAGE(33148, _("failed to deliver job " sge_u32 "." sge_u32 " to queue " SFQ))
#define MSG_JOB_RESCHEDULE_UU         _MESSAGE(33159, _("rescheduling job " sge_u32 "." sge_u32))
...
#define MSG_MAIL_AROKBODY_USSS        _MESSAGE(33185, _("Advance Reservation " sge_u32 " (" SFN ") Error resolved\n User       = " SFN "\n Error resolved Time = " SFN))
...
#define MSG_MAIL_AREXITEDSUBJ_US      "Advance Reservation " sge_u32 " (" SFN ") Finished"
#define MSG_MAIL_ARDELETEDSUBJ_US     "Advance Reservation " sge_u32 " (" SFN ") Deleted"
#define MSG_MAIL_ARERRORSUBJ_US       "Advance Reservation " sge_u32 " (" SFN ") Error"
#define MSG_MAIL_AROKSUBJ_US          "Advance Reservation " sge_u32 " (" SFN ") Error resolved"

#define MSG_MAIL_JOBKILLEDBODY_USS    _MESSAGE(33189, _("Job " sge_u32 " (" SFN ") was killed due to a kill execd on host " SFN))
...
#define MSG_MAIL_ARSTARTBODY_USSS     _MESSAGE(33197, _("Advance Reservation " sge_u32 " (" SFN ") Started\n User       = " SFN "\n Start Time = " SFN))
#define MSG_MAIL_AREXITBODY_USSS      _MESSAGE(33198, _("Advance Reservation " sge_u32 " (" SFN ") Finished\n User       = " SFN "\n End Time = " SFN))
#define MSG_MAIL_ARDELETETBODY_USSS   _MESSAGE(33199, _("Advance Reservation " sge_u32 " (" SFN ") Deleted\n User       = " SFN "\n Delete Time = " SFN))
#define MSG_MAIL_ARERRORBODY_USSS     _MESSAGE(33200, _("Advance Reservation " sge_u32 " (" SFN ") Error\n User       = " SFN "\n Error Time = " SFN))
...
#define MSG_JOB_MORETASKSTHAN_U       _MESSAGE(33204, _("job rejected: You try to submit a job with more than " sge_u32 " tasks"))
...
#define MSG_JOB_ALLOWEDJOBSPERUSER_UU  _MESSAGE(33207, _("job rejected: Only " sge_u32 " jobs are allowed per user (current job count: " sge_u32 ")"))
#define MSG_JOB_ALLOWEDJOBSPERCLUSTER _MESSAGE(33208, _("job rejected: Only " sge_u32 " jobs are allowed per cluster"))
...
#define MSG_JOB_NOWRITE_US            _MESSAGE(33227, _("job " sge_u32 " was rejected cause it can't be written: " SFN))
#define MSG_JOB_NOWRITE_U             _MESSAGE(33228, _("job " sge_u32 " was rejected cause it couldn't be written"))
#define MSG_JOB_DEPENDENCY_CYCLE_UU   _MESSAGE(33229, _("job " sge_u32 " dependency change would generate a dependency cycle with job " sge_u32))
...
#define MSG_JOB_GLOBALMASTERSLAVEA_S  _MESSAGE(33237, _("job rejected: overwriting global allocation_rule in %s requests is not allowed"))
#define MSG_JOB_MASTERSLAVE_A_SS      _MESSAGE(33238, _("job rejected: overwriting allocation_rule to " SFQ " is not allowed in scope " SFN))
...
#define MSG_JOB_DELETETASK_SUU        _MESSAGE(33242, _(SFN " has deleted job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_DELETETASKS_SSU       _MESSAGE(33243, _(SFN " has deleted job-array tasks " SFN " of job " sge_u32))
#define MSG_JOB_DELETEX_SSU           _MESSAGE(33244, _(SFN " has deleted " SFN " " sge_u32))
#define MSG_JOB_DISCONTINUEDTRANS_SU  _MESSAGE(33245, _("Discontinued delete transaction of user " SFQ " after job " sge_u32))
...
#define MSG_MAIL_TASKKILLEDBODY_UUSSS _MESSAGE(33247, _("Job-array task " sge_u32 "." sge_u32 " (" SFN ") was killed by " SFN "@" SFN))
#define MSG_MAIL_JOBKILLEDBODY_USSS   _MESSAGE(33248, _("Job " sge_u32 " (" SFN ")  was killed by " SFN "@" SFN))
#define MSG_MAIL_BECAUSE              _MESSAGE(33249, _("because "))
#define MSG_JOB_FORCEDDELTASK_SUU     _MESSAGE(33250, _("warning: " SFN " forced the deletion of job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_FORCEDDELJOB_SU       _MESSAGE(33251, _("warning: " SFN " forced the deletion of job " sge_u32))
#define MSG_COM_NOSYNCEXECD_SU        _MESSAGE(33252, _(SFN " unable to sync state with remote execd for the deletion of job \"" sge_u32 "\""))
#define MSG_JOB_REGDELTASK_SUU        _MESSAGE(33253, _(SFN " has registered the job-array task " sge_u32 "." sge_u32 " for deletion"))
#define MSG_JOB_REGDELX_SSU           _MESSAGE(33254, _(SFN " has registered the " SFN " " sge_u32 " for deletion"))
#define MSG_JOB_CHANGEATTR            _MESSAGE(33255, _("change job attributes"))
#define MSG_JOB_NOALTERNOWRITE_U      _MESSAGE(33256, _("alternation of job " sge_u32 " was rejected cause it couldn't be written"))
#define MSG_JOB_CHANGESHAREFUNC       _MESSAGE(33257, _("change share of job functional tickets"))
#define MSG_JOB_SETSHAREFUNC_SSUUU    _MESSAGE(33258, _(SFN "@" SFN " sets job functional ticket share of job " sge_u32 "." sge_u32 " to " sge_u32))
...
#define MSG_JOB_NOJOBARRAY_U          _MESSAGE(33266, _(sge_u32" is no job array"))
#define MSG_JOB_CHANGEOVERRIDETICKS   _MESSAGE(33267, _("change amount of override tickets"))
#define MSG_JOB_SETOVERRIDETICKS_SSUU _MESSAGE(33268, _(SFN "@" SFN " sets override tickets of job " sge_u32 " to " sge_u32))
#define MSG_JOB_PRIOINC               _MESSAGE(33269, _("increase job priority"))
#define MSG_JOB_JOBSHARESET_SSUU      _MESSAGE(33270, _(SFN "@" SFN " sets job share of job " sge_u32 " to " sge_u32))
...
#define MSG_JOB_HOLDLISTMOD_USS       _MESSAGE(33276, _("modified job id hold list of job " sge_u32 "\n   blocking jobs: " SFN "\n   exited jobs:   " SFN))
...
#define MSG_JOB_HOLDARRAYLISTMOD_USS  _MESSAGE(33285, _("modified job id hold array list of job " sge_u32 "\n   blocking jobs: " SFN "\n   exited jobs:   " SFN))
...
#define MSG_JOB_MOD_ONLYDECRUNNINGJOBCONSUMABLE_S     _MESSAGE(33311, _("denied: can only decrease consumable resource request " SFQ " of running job with -when now"))
#define MSG_JOB_MOD_GOTOWNJOBIDINHOLDJIDOPTION_U      _MESSAGE(33312, _("denied: job \"" sge_u32 "\" may not be it's own jobnet predecessor"))
#define MSG_JOB_MOD_UNKNOWNJOBTOWAITFOR_S             _MESSAGE(33313, _("denied: job " SFQ " not found"))
...
#define MSG_SGETEXT_CANT_MOD_RUNNING_JOBS_U           _MESSAGE(33318, _("job " sge_u32 " can't modify running jobs"))
#define MSG_SGETEXT_MUST_BE_OPR_TO_SS                 _MESSAGE(33319, _("denied: " SFQ " must be operator to " SFN))
#define MSG_SGETEXT_MOD_JOBS_SU                       _MESSAGE(33320, _("modified " SFN " of job " sge_u32))
#define MSG_SGETEXT_DOESNOTEXIST_SU                   _MESSAGE(33321, _("" SFN " \"" sge_u32 "\" does not exist"))
#define MSG_SGETEXT_DOESNOTEXISTTASK_SUS              _MESSAGE(33322, _("job \"" SFN "\" task \"" sge_u32 "\" does not exist for user(s) " SFN))
#define MSG_SGETEXT_DOESNOTEXISTTASKRANGE_SUUUS       _MESSAGE(33323, _("job \"" SFN "\" task id range \"" sge_u32 "-" sge_u32 ":" sge_u32 "\" comprises no tasks under user(s) " SFN))
#define MSG_SGETEXT_NO_PROJECT                        _MESSAGE(33324, _("job rejected: no project assigned to job"))
#define MSG_SGETEXT_MOD_JATASK_SUU                    _MESSAGE(33325, _("modified " SFN " of job-array task " sge_u32 "." sge_u32))
#define MSG_SGETEXT_MUST_BE_MGR_TO_SS                 _MESSAGE(33326, _("denied: " SFQ " must be manager to " SFN))
#define MSG_SGETEXT_MUST_BE_JOB_OWN_TO_SUS            _MESSAGE(33327, _("denied: " SFQ " must be at least owner of job " sge_u32 " to " SFN))
...
#define MSG_SGETEXT_MODIFIEDINLIST_SSUS               _MESSAGE(33336, _("" SFN "@" SFN " modified \"" sge_u32 "\" in " SFN " list"))
...
#define MSG_SGETEXT_OPTIONONLEONJOBS_U                _MESSAGE(33339, _("The specified option works only on jobs (" sge_u32 ")"))
#define MSG_SGETEXT_DEL_JOB_SS                        _MESSAGE(33340, _("The job " SFN " of user(s) " SFN " does not exist"))
#define MSG_SGETEXT_DOESNOTEXISTTASK_SU               _MESSAGE(33341, _("job \"" SFN "\" task \"" sge_u32 "\" does not exist"))
#define MSG_SGETEXT_DOESNOTEXISTTASKRANGE_SUUU        _MESSAGE(33342, _("job \"" SFN "\" task id range \"" sge_u32 "-" sge_u32 ":" sge_u32 "\" comprises no tasks"))
...
#define MSG_LOG_JOBUNKNOWNQMODCMD_U   _MESSAGE(33373, _("unknown job command type " sge_u32))
...
#define MSG_LOG_QUNKNOWNQMODCMD_U      _MESSAGE(33377, _("unknown queue command type " sge_u32))
#define MSG_JOB_NOMODJOBPERMS_SU      _MESSAGE(33378, _(SFN " - you have no permission to modify job \"" sge_u32 "\""))
#define MSG_JOB_CLEARERRORTASK_SSUU   _MESSAGE(33379, _(SFN "@" SFN " cleared error state of job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_CLEARERRORJOB_SSU     _MESSAGE(33380, _(SFN "@" SFN " cleared error state of job " sge_u32))
#define MSG_JOB_NOERRORSTATETASK_UU   _MESSAGE(33381, _("Job-array task " sge_u32 "." sge_u32 " is not in error state"))
#define MSG_JOB_NOERRORSTATEJOB_UU    _MESSAGE(33382, _("Job " sge_u32 " is not in error state"))
...
#define MSG_QUEUE_NOCLEANQPERMS       _MESSAGE(33407, _("cleaning a queue requires operator privileges"))
#define MSG_QUEUE_PURGEQ_SSS          _MESSAGE(33408, _(SFN "@" SFN " purged queue " SFQ))
#define MSG_JOB_NOFORCESUSPENDTASK_SUU _MESSAGE(33409, _(SFN " - can't force suspension job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_NOFORCESUSPENDJOB_SU  _MESSAGE(33410, _(SFN " - can't force suspension job " sge_u32))
#define MSG_JOB_FORCESUSPENDTASK_SUU  _MESSAGE(33411, _(SFN " - forced suspension of job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_FORCESUSPENDJOB_SU    _MESSAGE(33412, _(SFN " - forced suspension of job " sge_u32))
#define MSG_JOB_ALREADYSUSPENDED_SUU  _MESSAGE(33413, _(SFN " - job-array task " sge_u32 "." sge_u32 " is already suspended"))
#define MSG_JOB_ALREADYSUSPENDED_SU   _MESSAGE(33414, _(SFN " - job " sge_u32 " is already suspended"))
#define MSG_JOB_ALREADYUNSUSPENDED_SUU  _MESSAGE(33415, _(SFN " - job-array task " sge_u32 "." sge_u32 " is already unsuspended"))
#define MSG_JOB_ALREADYUNSUSPENDED_SU _MESSAGE(33416, _(SFN " - job " sge_u32 " is already unsuspended"))
#define MSG_JOB_NOSUSPENDTASK_SUU     _MESSAGE(33417, _(SFN " - can't suspend job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_NOSUSPENDJOB_SU       _MESSAGE(33418, _(SFN " - can't suspend job " sge_u32))
#define MSG_JOB_NOUNSUSPENDTASK_SUU   _MESSAGE(33419, _(SFN " - can't unsuspend job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_NOUNSUSPENDJOB_SU     _MESSAGE(33420, _(SFN " - can't unsuspend job " sge_u32))
#define MSG_JOB_SUSPENDTASK_SUU       _MESSAGE(33421, _(SFN " - suspended job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_SUSPENDJOB_SU         _MESSAGE(33422, _(SFN " - suspended job " sge_u32))
#define MSG_JOB_UNSUSPENDTASK_SUU     _MESSAGE(33424, _(SFN " - unsuspended job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_UNSUSPENDJOB_SU       _MESSAGE(33425, _(SFN " - unsuspended job " sge_u32))
#define MSG_JOB_RMADMSUSPENDTASK_SSUU _MESSAGE(33426, _(SFN "@" SFN " removed administrator suspension of job-array task " sge_u32 "." sge_u32 " (suspend threshold is still active)"))
#define MSG_JOB_RMADMSUSPENDJOB_SSU   _MESSAGE(33427, _(SFN "@" SFN " removed administrator suspension of job " sge_u32 " (suspend threshold is still active)"))
#define MSG_JOB_NOADMSUSPENDTASK_SUU  _MESSAGE(33428, _(SFN " - job-array task " sge_u32 "." sge_u32 " is not suspended by administrator - modify suspend threshold list of queue to remove suspend state"))
#define MSG_JOB_NOADMSUSPENDJOB_SU    _MESSAGE(33429, _(SFN " - job " sge_u32 " is not suspended by administrator - modify suspend threshold list of queue to remove suspend state"))
#define MSG_JOB_NOFORCEENABLETASK_SUU _MESSAGE(33430, _(SFN " - can't force enabling of job-array task " sge_u32 "." sge_u32 "\""))
#define MSG_JOB_NOFORCEENABLEJOB_SU   _MESSAGE(33431, _(SFN " - can't force enabling of job " sge_u32))
#define MSG_JOB_FORCEENABLETASK_SUU   _MESSAGE(33432, _(SFN " - forced enabling of job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_FORCEENABLEJOB_SU     _MESSAGE(33433, _(SFN " - forced enabling of job " sge_u32))
#define MSG_JOB_FORCEUNSUSPTASK_SSUU  _MESSAGE(33434, _(SFN "@" SFN " forced unsuspension of job-array task " sge_u32 "." sge_u32))
#define MSG_JOB_FORCEUNSUSPJOB_SSU    _MESSAGE(33435, _(SFN "@" SFN " forced unsuspension of job " sge_u32))
#define MSG_EVE_RESENTSIGNALTASK_UU   _MESSAGE(33436, _("got resend signal timer event for unknown array task " sge_u32 "." sge_u32))
...
#define MSG_JOB_JFINISH_UUS           _MESSAGE(33560, _("job " sge_u32 "." sge_u32 " finished on host " SFN))
#define MSG_JOB_FAILEDONHOST_UUSSSS   _MESSAGE(33561, _("job " sge_u32 "." sge_u32 " failed on host " SFN " " SFN " " SFN " because: %-.512s"))
#define MSG_GENERAL                   _MESSAGE(33562, _("general "))
#define MSG_JOB_JEXITNOTRUN_UU        _MESSAGE(33563, _("received JOB_EXIT for job " sge_u32 "." sge_u32 " which ist NOT running"))
...
#define MSG_LOG_QERRORBYJOBHOST_SUS   _MESSAGE(33571, _("queue " SFN " marked QERROR as result of job " sge_u32 "'s failure at host " SFN))

#define MSG_JOB_REPORTEXITQ_SUUSSSSS   _MESSAGE(33574, _("execd " SFN " reports exiting job (" sge_u32 "." sge_u32 "/" SFN " in queue " SFQ " that was supposed to be in queue " SFQ " at " SFQ " (state = " SFN ")"))
#define MSG_JOB_REPORTRUNQ_SUUSSU      _MESSAGE(33575, _("execd " SFN " reports running state for job (" sge_u32 "." sge_u32 "/" SFN ") in queue " SFQ " while job is in state " sge_u32 " "))
#define MSG_JOB_REPORTRUNFALSE_SUUSS   _MESSAGE(33576, _("execd@" SFN " reports running job (" sge_u32 "." sge_u32 "/" SFN ") in queue " SFQ " that was not supposed to be there - killing"))
#define MSG_JOB_REPORTEXITJ_UUU        _MESSAGE(33577, _("JEXITING report for job " sge_u32 "." sge_u32 ": which is in status " sge_u32))
#define MSG_JOB_FILESIZEEXCEED_SSUU    _MESSAGE(33578, _("file size resource limit exceeded by task " SFN " at " SFN " of job " sge_u32 "." sge_u32))
#define MSG_JOB_CPULIMEXCEED_SSUU      _MESSAGE(33579, _("cpu time resource limit exceeded by task " SFN " at " SFN " of job " sge_u32 "." sge_u32))
#define MSG_JOB_DIEDTHROUGHSIG_SSUUS   _MESSAGE(33580, _("task " SFN " at " SFN " of job " sge_u32 "." sge_u32 " died through signal " SFN))
#define MSG_JOB_TASKFAILED_SSUUU       _MESSAGE(33581, _("task " SFN " at " SFN " of job " sge_u32 "." sge_u32 " failed " sge_u32))
#define MSG_JOB_TASKFINISHED_SSUU      _MESSAGE(33582, _("task " SFN " at " SFN " of job " sge_u32 "." sge_u32 " finished"))
...
#define MSG_EXECD_UNKNOWNJ_SUUSUS      _MESSAGE(33585, _("execd " SFN " reports unknown job (" sge_u32 "." sge_u32 "/" SFN ") with unknown state " sge_u32 " in queue " SFQ))
...
#define MSG_QMODJOB_NOTENROLLED_UU                 _MESSAGE(33684, _("Modify operation can not be applied on job-array task " sge_u32 "." sge_u32 " in pending/hold state"))
#define MSG_QMODJOB_NOTENROLLED_U                  _MESSAGE(33685, _("Modify operation can not be applied on job " sge_u32 " in pending/hold state"))
...
#define MSG_QINSTANCE_SLOTSRESERVED_USS            _MESSAGE(33727, _("denied: " sge_u32 " slots are already reserved in " SFN "@" SFN " by an advance reservation"))
...
#define MSG_JOB_PRIOSET_SSUI                       _MESSAGE(33901, _(SFN "@" SFN " sets scheduling priority of job " sge_u32 " to %d"))
...
#define MSG_QMASTER_MAX_FILE_DESCRIPTORS_LIMIT_L   _MESSAGE(33903, _("qmaster will use max. %ld file descriptors for communication"))

#define MSG_QMASTER_MAX_EVC_LIMIT_I                _MESSAGE(33905, _("qmaster will accept max. %d dynamic event clients"))
#define MSG_QMASTER_COMMUNICATION_ERRORS           _MESSAGE(33906, _("abort qmaster startup due to communication errors"))

#define MSG_QMASTER_RECEIVED_OLD_LOAD_REPORT_UUS   _MESSAGE(33911, _("received old load report (" sge_u32 "< " sge_u32 ") from exec host " SFQ))
#define MSG_QMASTER_RECEIVED_EMPTY_LOAD_REPORT_S   _MESSAGE(33912, _("received empty load from exec host " SFQ))
#define MSG_QMASTER_FD_SETSIZE_LARGER_THAN_LIMIT_U _MESSAGE(33913, _("FD_SETSIZE is limited to " sge_u32 " file descriptors on this system."))
#define MSG_QMASTER_FD_SETSIZE_COMPILE_MESSAGE1_U  _MESSAGE(33914, _("If you want to support more than " sge_u32 " qmaster clients you have to"))
...
#define MSG_QMASTER_FD_SOFT_LIMIT_SETTINGS_U       _MESSAGE(33917, _("qmaster soft descriptor limit is set to " sge_u32))
#define MSG_QMASTER_FD_HARD_LIMIT_SETTINGS_U       _MESSAGE(33918, _("qmaster hard descriptor limit is set to " sge_u32))
#define MSG_QMASTER_READ_JDB_WITH_X_ENTR_IN_Y_SECS_UU _MESSAGE(33919, _("read job database with " sge_u32 " entries in " sge_u32 " seconds"))
...
#define MSG_QMASTER_THREADCOUNT_IS                 _MESSAGE(33930, _("%d " SFN " threads are enabled"))
#define MSG_AR_GRANTED_U                           _MESSAGE(33931, _("Your advance reservation " sge_u32 " has been granted"))
#define MSG_AR_MAXARSPERCLUSTER_U                  _MESSAGE(33932, _("rejected: only " sge_u32 " advance reservations are allowed per cluster"))
#define MSG_JOB_JOBARSET_SSUU                      _MESSAGE(33934, _(SFN "@" SFN " sets job advance reservation of job " sge_u32 " to " sge_u32))
#define MSG_JOB_CHANGEJOBAR                        _MESSAGE(33935, _("changed job advance reservation"))
#define MSG_JOB_NOAREXISTS_U                       _MESSAGE(33936, _("the advance reservation id " sge_u32 " is invalid"))
#define MSG_JOB_HRTLIMITTOOLONG_U                  _MESSAGE(33938, _("the job duration is longer than duration of the advance reservation id " sge_u32))
#define MSG_JOB_HRTLIMITOVEREND_U                  _MESSAGE(33939, _("the job duration exceeds the end time of the advance reservation id " sge_u32))
...
#define MSG_JOB_ARNOLONGERAVAILABE_U               _MESSAGE(33945, _("the advance reservation " sge_u32 " is no longer available"))
...
#define MSG_GDI_KEYSTR_LENGTH_U                    _MESSAGE(33949, _("string is longer than " sge_u32 ", this is not allowed for objectnames"))
...
#define MSG_JOB_DISCONTTASKTRANS_SUU               _MESSAGE(33952, _("Discontinued delete transaction of user " SFQ " in job " sge_u32 " at task " sge_u32))
#define MSG_JOB_ALREADYDELETED_U                   _MESSAGE(33953, _("job " sge_u32 " is already in deletion"))
#define MSG_JOB_TERMJOBDUETOLIMIT_UU               _MESSAGE(33954, _("terminating job " sge_u32 "." sge_u32 " because runtime limit is reached"))
#define MSG_JOB_ADDJOBTRIGGER_UUUU                 _MESSAGE(33955, _("added trigger to terminate job " sge_u32 "." sge_u32 " when runtime limit is reached (" sge_u32 " + " sge_u32 ")"))
#define MSG_JOB_DELJOBTRIGGER_UU                   _MESSAGE(33956, _("removing trigger to terminate job " sge_u32 "." sge_u32))
#define MSG_JOB_CHGFORCED_UU                       _MESSAGE(33957, _("changed non-forced request to forced request for job " sge_u32 "." sge_u32 "because host can't be contacted"))
...
#define MSG_JOB_RESOURCESNOLONGERAVAILABLE_UU      _MESSAGE(33960, _("resources no longer available for start of job " sge_u32 "." sge_u32))
...
#define MSG_REQLIMIT_EMPTYUSRINVALID               _MESSAGE(33971, _("empty user filter of request limit is invalid"))
#define MSG_REQLIMIT_HGRPFILTERNOEXIST_S           _MESSAGE(33972, _("host filter " SFQ " of request limit does not match a hgroup"))
#define MSG_REQLIMIT_HOSTFILTERNOEXIST_S           _MESSAGE(33973, _("host filter " SFQ " of request is not resolvable"))
#define MSG_REQLIMIT_FORMATINVALID                 _MESSAGE(33974, _("format of request limit filter is invalid"))
#define MSG_REQLIMIT_INVALIDCHAR_S                 _MESSAGE(33975, _("request limit contains invalid character" SFQ))
