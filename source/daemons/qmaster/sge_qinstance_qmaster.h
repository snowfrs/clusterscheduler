...
bool
sge_qmaster_qinstance_state_set_manual_suspended(lListElem *this_elem, bool set_state, uint64_t gid_session);

bool
sge_qmaster_qinstance_state_set_unknown(lListElem *this_elem, bool set_state, uint64_t gid_session);

bool
sge_qmaster_qinstance_state_set_error(lListElem *this_elem, bool set_state, uint64_t gid_session);
