...
bool
rqs_diff_projects(const lListElem *new_rqs, const lListElem *old_rqs, lList **new_acl, lList **old_acl,
                  const lList *master_project_list);

bool
scope_is_referenced_rqs(const lListElem *rqs, int filter_type, const char *name);
