...
int
ckpt_spool(ocs::gdi::Packet *packet, ocs::gdi::Task *task, lList **alpp, lListElem *ep, gdi_object_t *object);
...
int
sge_del_ckpt(ocs::gdi::Packet *packet, ocs::gdi::Task *task, lListElem *, lList **, char *, char *);
