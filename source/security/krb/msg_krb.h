...
** krb/src/krb_util.c
*/
#define MSG_KRB_COULDNOTDECRYPTTGTFORJOBXY_DS   _MESSAGE(53074, _("could not decrypt TGT for job " sge_u32 " - " SFN))
#define MSG_KRB_COULDNOTRENEWTGTFORJOBXY_DS     _MESSAGE(53075, _("could not renew TGT for job " sge_u32 " - " SFN))
#define MSG_KRB_COULDNOTECRYPTTGTFORJOBXY_DS    _MESSAGE(53076, _("could not encrypt TGT for job " sge_u32 " - " SFN))
#define MSG_KRB_COULDNOTSTORERENEWEDTGTFORXJOBY_SD _MESSAGE(53077, _("could not store renewed TGT for " SFN " - job " sge_u32))
#define MSG_KRB_COULDNOTGETUSERIDFORXY_SD       _MESSAGE(53078, _("could not get user ID for " SFN " - job " sge_u32))
