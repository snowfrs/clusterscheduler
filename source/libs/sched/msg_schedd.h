...
#define MSG_SCHEDD_INFO_PESLOTSNOTINRANGE_SI          _MESSAGE(47065, _("cannot run in PE " SFQ " because it only offers " sge_u32 " slots"))
...
#define MSG_SCHEDD_INFO_TURNEDOFF_                    _MESSAGE(47070, _("(Collecting of scheduler job information is turned off - use qalter -w p job_id to verify if the job can be scheduled)")) 
...
#define MSG_SCHEDD_INFO_TURNEDOFF                     _MESSAGE(47115, _("(Collecting of scheduler job information is turned off - use qalter -w p job_id to verify if the job can be scheduled)"))         
...
#define MSG_SCHEDD_INFO_CANNOTRUNINQUEUECAL_SU        _MESSAGE(47137, _("cannot run in queue instance " SFQ " because the job runtime of " sge_u32 " sec. is too long"))
...
#define MSG_SCHEDD_INFO_QINOTARRESERVED_SI            _MESSAGE(47146, _("cannot run in queue instance " SFQ " because it was not reserved by advance reservation " sge_u32))
...
#define MSG_SCHEDD_INFO_QNOTARRESERVED_SI             _MESSAGE(47148, _("cannot run in queue " SFQ " because it was not reserved by advance reservation " sge_u32))
...
#define MSG_SCHEDD_INFO_ARISINERROR_I                 _MESSAGE(47150, _("cannot run because requested advance reservation " sge_u32 " is in error state"))
...
#define MSG_SCHEDD_SHOULDHAVEFINISHED_UUU                   _MESSAGE(47209, _("job " sge_u32 "." sge_u32 " should have finished since " sge_u32 "s"))
...
#define MSG_ATTRIB_USINGXFORY_US                _MESSAGE(47256, _("using " sge_u32 " for " SFN))
...
#define MSG_CANTFINDTASKINJOB_UU                      _MESSAGE(47361, _("could not find task " sge_u32 " in job " sge_u32))
