...
#define MSG_CULL_LEELEMNULL              _MESSAGE(41091, _("element is nullptr"))
...
#define MSG_CULL_LEDESCRNULL             _MESSAGE(41094, _("descriptor is nullptr, empty describtor"))
...
#define MSG_CULL_LEFILENULL              _MESSAGE(41097, _("file pointer is nullptr"))
...
#define MSG_CULL_LELISTNULL              _MESSAGE(41102, _("list is nullptr"))
...
#define MSG_CULL_LEENUMNULL              _MESSAGE(41116, _("lEnumeration is nullptr"))
#define MSG_CULL_LECONDNULL              _MESSAGE(41117, _("lCondition is nullptr"))
...
#define MSG_CULL_LESORTORDNULL           _MESSAGE(41125, _("lSortOrder is nullptr"))
...
#define MSG_CULL_LENULLARGS              _MESSAGE(41129, _("function argument is nullptr"))
...
#define MSG_CULL_LENULLSTRING            _MESSAGE(41139, _("string nullptr not allowed"))
...
#define MSG_CULL_POINTER_NULLELEMENTFORX_S                 _MESSAGE(41069, _("!!!!!!!!!! got nullptr element for " SFN " !!!!!!!!!!"))
