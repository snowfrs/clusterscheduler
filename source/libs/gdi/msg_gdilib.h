...
#define MSG_GDI_CANT_SEND_MSG_TO_PORT_ON_HOST_SUSS       _MESSAGE(43118, _("unable to send message to " SFN " using port " sge_u32 " on host " SFQ ": " SFN))
#define MSG_GDI_UNABLE_TO_CONNECT_SUS                    _MESSAGE(43119, _("unable to contact " SFN " using port " sge_u32 " on host " SFQ))
#define MSG_GDI_GETGRGIDXFAILEDERRORX_U                  _MESSAGE(43120, _("unable to resolve group name for group ID, " sge_u32))
#define MSG_GDI_SENDINGGDIREQUESTFAILED                  _MESSAGE(43121, _("failed sending gdi request"))
#define MSG_GDI_RECEIVEGDIREQUESTFAILED_US               _MESSAGE(43122, _("failed receiving gdi request response for mid=" sge_u32 " (" SFN ")."))
...
#define MSG_GDI_ERRORUNPACKINGGDIREQUEST_SSUS            _MESSAGE(43126, _("error unpacking gdi request from %s/%s/" sge_u32 ": " SFN))
#define MSG_GDI_ERROR_INVALIDVALUEXFORARTOOP_D           _MESSAGE(43127, _("invalid value (" sge_u32 ") for ar->op"))
...
#define MSG_GDI_CANT_GET_COM_HANDLE_SSUUS    _MESSAGE(43297, _("communication error for \"" SFN "/" SFN "/" sge_u32 "\" running on port " sge_u32 ": " SFQ))
#define MSG_GDI_CANT_CONNECT_HANDLE_SSUUS    _MESSAGE(43298, _("communication error for \"" SFN "/" SFN "/" sge_u32 "\" using connect port " sge_u32 ": " SFQ))
