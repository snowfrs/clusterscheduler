...
bool
ocs::QHostParameterClient::parse_cmdline_from_file(lList **cmdline, lList **answer_list, const char *file) {
   DENTER(TOP_LAYER);
...
int
ocs::QHostParameterClient::parse_switch_list(lList **ppcmdline, lList **alpp) {
   DENTER(TOP_LAYER);
   uint32_t helpflag;
