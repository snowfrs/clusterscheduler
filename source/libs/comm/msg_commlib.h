...
#define MSG_CL_TCP_FW_ENDPOINT_X_NOT_FROM_RESERVED_PORT_SSU                   _MESSAGE(85037, _("debug client \"" SFN "/" SFN "/" sge_u32 "\" did not use a reserved port below 1024"))
#define MSG_CL_TCP_FW_ENDPOINT_X_NOT_FROM_LOCAL_HOST_SSUS                     _MESSAGE(85038, _("debug client \"" SFN "/" SFN "/" sge_u32 "\" is not running on host " SFQ ""))
#define MSG_CL_TCP_FW_LOCAL_HOST_CONNECT_ERROR                                _MESSAGE(85039, _("debug client is not running on local host"))
#define MSG_CL_TCP_FW_STANDARD_ENDPOINT_X_NOT_FROM_RESERVED_PORT_SSU          _MESSAGE(85040, _("client \"" SFN "/" SFN "/" sge_u32 "\" did not use a reserved port below 1024"))
...
#define MSG_CL_COMMLIB_CLOSING_SSL                                            _MESSAGE(85044, _("closing \"" SFN "/" SFN "/%ld\""))
...
#define MSG_CL_COMMLIB_HOSTNAME_EXEEDS_MAX_HOSTNAME_LENGTH_SU                 _MESSAGE(85047, _("hostname " SFQ " exceeds MAXHOSTNAMELEN(=" sge_u32 ")"))
#define MSG_CL_COMMLIB_SSL_ERROR_USS                                          _MESSAGE(85048, _("SSL error(nr.:" sge_u32 ") in %s: %s"))
...
#define MSG_CL_COMMLIB_SSL_ERROR_NR_AND_TEXT_USS      _MESSAGE(85066, _("[ID=" sge_u32 "] in module " SFQ ": " SFQ))
