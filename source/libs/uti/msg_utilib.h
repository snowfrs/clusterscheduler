...
#define MSG_SYSTEM_GETPWUIDFAILED_uS            _MESSAGE(49059, _("getpwuid(" uid_t_fmt ") failed: " SFN))
#define MSG_SYSTEM_CHANGEUIDORGIDFAILED         _MESSAGE(49061, _("tried to change uid/gid without being root"))
#define MSG_SYSTEM_GIDLESSTHANMINIMUM_Sgg       _MESSAGE(49062, _("gid of user " SFN " (" gid_t_fmt ") less than minimum allowed in conf (" gid_t_fmt ")"))
#define MSG_SYSTEM_UIDLESSTHANMINIMUM_Suu       _MESSAGE(49063, _("uid of user " SFN " (" uid_t_fmt ") less than minimum allowed in conf (" uid_t_fmt ")"))
#define MSG_SYSTEM_SETGIDFAILED_g               _MESSAGE(49064, _("setgid(" gid_t_fmt ") failed"))
#define MSG_SYSTEM_SETUIDFAILED_u               _MESSAGE(49065, _("setuid(" uid_t_fmt ") failed"))
#define MSG_SYSTEM_SETEGIDFAILED_g              _MESSAGE(49066, _("setegid(" gid_t_fmt ") failed"))
...
#define MSG_UTI_MONITOR_GDIEXT_FFFFFFFFFFFFUUU  _MESSAGE(59122, _("EXECD (l:%.2f,j:%.2f,c:%.2f,p:%.2f,a:%.2f)/s GDI (a:%.2f,g:%.2f,m:%.2f,d:%.2f,c:%.2f,t:%.2f,p:%.2f)/s OTHER (ql:" sge_u32 ",rql:" sge_u32 ",wrql:" sge_u32 ")"))
...
#define MSG_UTI_MONITOR_SCHEXT_UUUUUUUUUU       _MESSAGE(59137, _("malloc:                   arena(" sge_u32 ") |ordblks(" sge_u32 ") | smblks(" sge_u32 ") | hblksr(" sge_u32 ") | hblhkd(" sge_u32 ") usmblks(" sge_u32 ") | fsmblks(" sge_u32 ") | uordblks(" sge_u32 ") | fordblks(" sge_u32 ") | keepcost(" sge_u32 ")"))
...
#define MSG_SMF_CONTRACT_ABANDON_FAILED_US      _MESSAGE(59149, _("can't abandon contract " sge_u32 ": " SFQ))
...
#define MSG_SMF_DISABLE_FAILED_SSUU             _MESSAGE(59152, _("could not temporary disable instance " SFQ " : " SFQ "   [euid=" sge_u32 ", uid=" sge_u32 "]"))
...
#define MSG_TMPNAM_SGE_MAX_PATH_LENGTH_US       _MESSAGE(59162, _("reached max path length of " sge_u32 " bytes for file " SFQ))
...
#define MSG_SYSTEMD_AFTER_RETRIES_I                _MESSAGE(59255, _(" (%d retries after EINTR)"))
...
#define MSG_OPENSSL_OPEN_LIB_SS                    _MESSAGE(59281, _("can't open shared library " SFN ": " SFN4))
#define MSG_OPENSSL_LOAD_FUNC_SS                   _MESSAGE(59282, _("can't load function " SFN ": " SFN4))
#define MSG_OPENSSL_INIT_FAILED                    _MESSAGE(59283, _("openssl initialization failed"))
#define MSG_CANNOT_CREATE_SSL_CONTEXT_S            _MESSAGE(59284, _("cannot create SSL context: " SFN4))
#define MSG_CANNOT_CREATE_SSL_S                    _MESSAGE(59285, _("cannot create SSL: " SFN4))
#define MSG_CANNOT_SET_FD_S                        _MESSAGE(59286, _("cannot set file descriptor to SSL: " SFN4))
#define MSG_CANNOT_READ_DS                         _MESSAGE(59287, _("cannot read from SSL: %d: " SFN4))
#define MSG_CANNOT_WRITE_DS                        _MESSAGE(59288, _("cannot write to SSL: %d: " SFN4))
#define MSG_CANNOT_ACCEPT_DS                       _MESSAGE(59289, _("cannot SSL accept connection: %d: " SFN4))
#define MSG_CANNOT_SET_SERVERNAME_S                _MESSAGE(59290, _("cannot set server name for SSL SNI: " SFN4))
#define MSG_CANNOT_CONNECT_DS                      _MESSAGE(59291, _("cannot SSL connect: %d: " SFN4))
#define MSG_SSL_SELECT_TIMEOUT                     _MESSAGE(59292, _("SSL select timeout after WANT_READ/WRITE"))
