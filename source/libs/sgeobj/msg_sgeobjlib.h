...
#define MSG_CKPTREFINJOB_SU         _MESSAGE(64001, _("Checkpointing object " SFQ " is still referenced in job " sge_u32 "."))
...
#define MSG_JOB_JOB_ID_U                  _MESSAGE(64033, _("" sge_u32 ""))
#define MSG_JOB_JOB_JATASK_ID_UU          _MESSAGE(64034, _(sge_u32 "." sge_u32))
#define MSG_JOB_JOB_JATASK_PETASK_ID_UUS  _MESSAGE(64035, _(sge_u32 "." sge_u32 " task " SFN))
...
#define MSG_PEREFINJOB_SU                               _MESSAGE(64059, _("Pe " SFQ " is still referenced in job " sge_u32 "."))
 ...
 * sge_event.c
 */
#define MSG_EVENT_ADDOBJECTX_USS                   _MESSAGE(64090, _(sge_u32". EVENT ADD " SFN " " SFN))
#define MSG_EVENT_DELOBJECTX_USS                   _MESSAGE(64091, _(sge_u32". EVENT DEL " SFN " " SFN))
#define MSG_EVENT_MODOBJECTX_USS                   _MESSAGE(64092, _(sge_u32". EVENT MOD " SFN " " SFN))
#define MSG_EVENT_OBJECTLISTXELEMENTS_USI          _MESSAGE(64093, _(sge_u32". EVENT " SFN " LIST %d Elements"))
#define MSG_EVENT_MESSAGE_US                       _MESSAGE(64094, _(sge_u32". EVENT " SFN))
#define MSG_EVENT_ADDOBJECTX_USU                   _MESSAGE(64095, _(sge_u32". EVENT ADD " SFN " " sge_u32))
#define MSG_EVENT_DELOBJECTX_USU                   _MESSAGE(64096, _(sge_u32". EVENT DEL " SFN " " sge_u32))
#define MSG_EVENT_MODOBJECTX_USU                   _MESSAGE(64097, _(sge_u32". EVENT MOD " SFN " " sge_u32))

#define MSG_EVENT_MODSCHEDDPRIOOFJOBXTOY_USI       _MESSAGE(64100, _(sge_u32". EVENT MODIFY SCHEDULING PRIORITY OF JOB " SFN " TO %d"))
#define MSG_EVENT_JOBXUSAGE_US                     _MESSAGE(64101, _(sge_u32". EVENT JOB " SFN " USAGE"))
#define MSG_EVENT_JOBXFINALUSAGE_US                _MESSAGE(64102, _(sge_u32". EVENT JOB " SFN " FINAL USAGE"))
#define MSG_EVENT_UNSUSPENDQUEUEXONSUBORDINATE_US  _MESSAGE(64103, _(sge_u32". EVENT UNSUSPEND QUEUE " SFN " ON SUBORDINATE"))
#define MSG_EVENT_SUSPENDQUEUEXONSUBORDINATE_US    _MESSAGE(64104, _(sge_u32". EVENT SUSPEND QUEUE " SFN " ON SUBORDINATE"))
#define MSG_EVENT_JOBXFINISH_US                    _MESSAGE(64105, _(sge_u32". EVENT JOB " SFN " FINISH"))
#define MSG_EVENT_DELQINSTANCE_USS                 _MESSAGE(64106, _(sge_u32". EVENT DEL QUEUE INSTANCE " SFN "@" SFN))
#define MSG_EVENT_ADDQINSTANCE_USS                 _MESSAGE(64107, _(sge_u32". EVENT ADD QUEUE INSTANCE " SFN "@" SFN))
#define MSG_EVENT_MODQINSTANCE_USS                 _MESSAGE(64108, _(sge_u32". EVENT MOD QUEUE INSTANCE " SFN "@" SFN))
#define MSG_EVENT_SHARETREEXNODESYLEAFS_UII        _MESSAGE(64109, _(sge_u32". EVENT SHARETREE %d nodes %d leafs"))
...
#define MSG_CONF_NR_DYNAMIC_EVENT_CLIENT_EXCEEDS_MAX_FILEDESCR_U _MESSAGE(64309, _("nr of dynamic event clients exceeds max file descriptor limit, setting MAX_DYN_EC=" sge_u32))
...
#define MSG_PARSE_MOD_REJECTED_DUE_TO_AR_SSU     _MESSAGE(60396, _("denied: removing " SFQ " from " SFN " would break advance reservation " sge_u32))
#define MSG_PARSE_MOD_REJECTED_DUE_TO_AR_PE_SLOTS_U _MESSAGE(60397, _("denied: lowering slots amount below " sge_u32 " would break advance reservations"))
#define MSG_PARSE_MOD2_REJECTED_DUE_TO_AR_SSU    _MESSAGE(60398, _("denied: changing " SFQ " to " SFN " would break advance reservation " sge_u32))
#define MSG_PARSE_MOD3_REJECTED_DUE_TO_AR_SU     _MESSAGE(60399, _("denied: the change in " SFQ " would break advance reservation " sge_u32))
...
#define MSG_ATTR_INVALID_ULONGVALUE_USUU         _MESSAGE(64508, _(sge_u32" is an invalid value for the " SFQ " attribute - it must be a value between " sge_u32 " and " sge_u32))
